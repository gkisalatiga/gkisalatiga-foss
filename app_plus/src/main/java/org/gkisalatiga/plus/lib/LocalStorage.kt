...
enum class LocalStorageKeys {
    ...
    LOCAL_KEY_GET_CACHED_BIBLE_FILE_LOCATION,
    LOCAL_KEY_GET_CACHED_PDF_FILE_LOCATION,
    LOCAL_KEY_GET_BIBLE_LAST_ACCESS_MILLIS,
    LOCAL_KEY_GET_BIBLE_LAST_DOWNLOAD_MILLIS,
    LOCAL_KEY_GET_BIBLE_METADATA,
    LOCAL_KEY_GET_PDF_LAST_ACCESS_MILLIS,
    LOCAL_KEY_GET_PDF_LAST_DOWNLOAD_MILLIS,
    LOCAL_KEY_GET_PDF_METADATA,
    LOCAL_KEY_IS_BIBLE_FILE_DOWNLOADED,
    LOCAL_KEY_IS_BIBLE_FILE_MARKED_AS_FAVORITE,
